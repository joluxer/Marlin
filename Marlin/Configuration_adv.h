...
// LCD Print Progress options
  ...
  // SD Card Sorting options
    ...
    #define SDSORT_LIMIT       75     // Maximum number of sorted items (10-256). Costs 27 bytes each.
...
#define BABYSTEPPING
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping.
    ...
    //#define MOVE_Z_WHEN_IDLE              // Jump to the move Z menu on doubleclick when printer is idle.
      ...
      #define MOVE_Z_IDLE_MULTIPLICATOR 0.025   // Multiply 1mm by this factor for the move step size.
    #endif
  #endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_NO_STEPPER_TIMEOUT        1  // Enable for XYZ steppers to stay powered on during filament change.
